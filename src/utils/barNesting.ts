 ...
 * Root 1.0, first level 0.85, second 0.75, and no smaller however deep the tree
 * goes: the bar has to keep holding a legible progress percentage, and depth past
 * the second level is carried by the label indent and the hierarchy connectors
 * instead. */
export const BAR_HEIGHT_RATIO_BY_DEPTH: readonly number[] = [1, 0.85, 0.75];
